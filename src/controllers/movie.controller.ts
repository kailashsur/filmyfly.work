  ...
  try {
    ...
    const whereClause = searchQuery ? {
      OR: [
        ...
        { cast: { contains: searchQuery, mode: 'insensitive' as const } },
        { keywords: { contains: searchQuery, mode: 'insensitive' as const } },
    ...
    // Get movies with pagination and search filter
