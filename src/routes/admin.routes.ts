...
import { getAstroSettings, postAstroSettings } from '../controllers/astro-settings.controller.js';
import {
  getStaticPageList,
  getAddStaticPage,
  postAddStaticPage,
...
// Astro Settings Management
router.get('/admin/astro-settings', verifyAdminToken, getAstroSettings);
router.post('/admin/astro-settings', verifyAdminToken, postAstroSettings);
